#!/usr/bin/env python3
"""Generate ElevenLabs narration audio for the GraphRAG police knowledge graph demo."""
import json, urllib.request, os, sys

API_KEY = os.environ.get("ELEVENLABS_API_KEY", "")
VOICE_ID = "FTNCalFNG5bRnkkaP5Ug"  # Otto - Native German male, warm narrator

NARRATION_TEXT = """Hallo und willkommen beim intelligenten Wissensgraphen — einer Demo-Anwendung für Knowledge Graph und GraphRAG.
...
Genau hier setzt diese Demo an — mit einer Multi-Layered Ontologie-Architektur in vier Schichten.
